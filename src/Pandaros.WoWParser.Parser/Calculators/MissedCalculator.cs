...
namespace Pandaros.WoWParser.Parser.Calculators
{
    public class MissedCalculator : BaseCalculator
    {
        ...
        public MissedCalculator(IPandaLogger logger, IStatsLogger reporter, ICombatState state, MonitoredFight fight) : base(logger, reporter, state, fight)
        {
        ...
        {
            if (combatEvent.DestFlags.FlagType == UnitFlags.UnitFlagType.Npc)
            {
